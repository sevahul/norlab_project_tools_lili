...
def extract_trajectories(mcap_file, output_root="output"):
    ...
    output_theodolite_dir = output_dir / "raw"
    output_theodolite_dir.mkdir(parents=True, exist_ok=True)
    
    out_t265 = output_dir / "t265_trajectory.txt"
    out_legged = output_dir / "legged_trajectory.txt"
    ...
    out_theo_processed = process_raw_theodolite(
        out_theo_raw,
        output_path=output_dir / "theodolite_trajectory.txt",
    )
